...
return [
    ...
    'manifestPath' => App::env('CRAFT_WEB_ROOT') . '@webroot/dist/.vite/manifest.json', // Waar staat het manifest bestand (eenmaal de scss gebuild is naar css, wordt in deze file de link tussen de scss en css bestanden opgeslagen)
