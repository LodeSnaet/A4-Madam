...
return [
    ...
    'manifestPath' => '@webroot/dist/manifest.json', // Waar staat het manifest bestand (eenmaal de scss gebuild is naar css, wordt in deze file de link tussen de scss en css bestanden opgeslagen)
